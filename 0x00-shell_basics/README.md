...
6. [Welcome my first directory](./6-firstdirectory) : A script that will create a directory named `my_first_directory` in the `/tmp/` directory.
...
9. [Bye bye my first directory](./9-firstdirdeletion) : A script that will delete the the directory `my first directory` that is in the `/tmp/` directory path.
